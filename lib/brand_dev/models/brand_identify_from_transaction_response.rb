...
module BrandDev
  module Models
    ...
    class BrandIdentifyFromTransactionResponse < BrandDev::Internal::Type::BaseModel
      ...
      #
      #   @return [BrandDev::Models::BrandIdentifyFromTransactionResponse::CacheMetadata]
      required :cache_metadata, -> { BrandDev::Models::BrandIdentifyFromTransactionResponse::CacheMetadata }
      ...
      #
      #   @return [BrandDev::Models::BrandIdentifyFromTransactionResponse::KeyMetadata, nil]
      optional :key_metadata, -> { BrandDev::Models::BrandIdentifyFromTransactionResponse::KeyMetadata }
      ...
      #   {BrandDev::Models::BrandIdentifyFromTransactionResponse} for more details.
      #
      #   @param cache_metadata [BrandDev::Models::BrandIdentifyFromTransactionResponse::CacheMetadata] Cache outcome for this response. Composite responses are hits only when every ca
      #
      #   @param brand [BrandDev::Models::BrandIdentifyFromTransactionResponse::Brand] Detailed brand information
      #
      #   @param code [Integer] HTTP status code
      #
      #   @param key_metadata [BrandDev::Models::BrandIdentifyFromTransactionResponse::KeyMetadata] Metadata about the API key used for the request. Included in every response when
      #
      #   @param status [String] Status of the response, e.g., 'ok'

      # @see BrandDev::Models::BrandIdentifyFromTransactionResponse#cache_metadata
      class CacheMetadata < BrandDev::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, BrandDev::Models::BrandIdentifyFromTransactionResponse::CacheMetadata::Status]
        required :status,
                 enum: -> { BrandDev::Models::BrandIdentifyFromTransactionResponse::CacheMetadata::Status }

        # @!method initialize(age_ms:, status:)
        #   Some parameter documentations has been truncated, see
        #   {BrandDev::Models::BrandIdentifyFromTransactionResponse::CacheMetadata} for more
        #   details.
        #
        #   Cache outcome for this response. Composite responses are hits only when every
        #   cache-controlled fetch contributing to the output was a hit; age_ms is the
        ...
        #
        #   @param status [Symbol, BrandDev::Models::BrandIdentifyFromTransactionResponse::CacheMetadata::Status] Whether the response was served from cache, required fresh work, or honored zero

        # Whether the response was served from cache, required fresh work, or honored
        # zero-data-retention cache bypass.
        #
        # @see BrandDev::Models::BrandIdentifyFromTransactionResponse::CacheMetadata#status
        module Status
      ...
      class Brand < BrandDev::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, BrandDev::Models::BrandIdentifyFromTransactionResponse::Brand::PrimaryLanguage, nil]
        optional :primary_language,
                 enum: -> { BrandDev::Models::BrandIdentifyFromTransactionResponse::Brand::PrimaryLanguage },
                 nil?: true
        ...
        #
        #   @param primary_language [Symbol, BrandDev::Models::BrandIdentifyFromTransactionResponse::Brand::PrimaryLanguage, nil] Language to force for the retrieved brand data.
        #
        ...
        class Color < BrandDev::Internal::Type::BaseModel
          ...
          #   logo image pixels.
          #
          #   @return [Symbol, BrandDev::Models::BrandIdentifyFromTransactionResponse::Brand::Color::Source, nil]
          optional :source,
                   enum: -> { BrandDev::Models::BrandIdentifyFromTransactionResponse::Brand::Color::Source }

          # @!method initialize(hex: nil, name: nil, source: nil)
          #   Some parameter documentations has been truncated, see
          #   {BrandDev::Models::BrandIdentifyFromTransactionResponse::Brand::Color} for more
          #   details.
          #
          #   @param hex [String] Color in hexadecimal format
          #
          #   @param name [String] Name of the color
          #
          #   @param source [Symbol, BrandDev::Models::BrandIdentifyFromTransactionResponse::Brand::Color::Source] Where the color was observed: 'site' colors come from the website's own theme si

          # Where the color was observed: 'site' colors come from the website's own theme
          # signals (rendered page colors, manifest, theme-color meta), 'logo' colors from
          # logo image pixels.
          #
          # @see BrandDev::Models::BrandIdentifyFromTransactionResponse::Brand::Color#source
          module Source
            extend BrandDev::Internal::Type::Enum
        ...
        # Language to force for the retrieved brand data.
        #
        # @see BrandDev::Models::BrandIdentifyFromTransactionResponse::Brand#primary_language
        ...
        class Social < BrandDev::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, BrandDev::Models::BrandIdentifyFromTransactionResponse::Brand::Social::Type, nil]
          optional :type, enum: -> { BrandDev::Models::BrandIdentifyFromTransactionResponse::Brand::Social::Type }
          ...
          #   @param type [Symbol, BrandDev::Models::BrandIdentifyFromTransactionResponse::Brand::Social::Type] Type of social media platform
          #
          #   @param url [String] URL of the social media page

          # Type of social media platform
          #
          # @see BrandDev::Models::BrandIdentifyFromTransactionResponse::Brand::Social#type
          module Type
            extend BrandDev::Internal::Type::Enum
      ...
      # @see BrandDev::Models::BrandIdentifyFromTransactionResponse#key_metadata
