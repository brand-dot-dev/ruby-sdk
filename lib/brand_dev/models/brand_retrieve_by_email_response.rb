...
module BrandDev
  module Models
    ...
    class BrandRetrieveByEmailResponse < BrandDev::Internal::Type::BaseModel
      ...
      #
      #   @return [BrandDev::Models::BrandRetrieveByEmailResponse::KeyMetadata, nil]
      optional :key_metadata, -> { BrandDev::Models::BrandRetrieveByEmailResponse::KeyMetadata }
      ...
      class Brand < BrandDev::Internal::Type::BaseModel
        ...
        #
        #   @return [BrandDev::Models::BrandRetrieveByEmailResponse::Brand::Employees, nil]
        optional :employees, -> { BrandDev::Models::BrandRetrieveByEmailResponse::Brand::Employees }
        ...
        #
        #   @param employees [BrandDev::Models::BrandRetrieveByEmailResponse::Brand::Employees] Employee headcount information for the brand (will be null if unknown)
        #
        ...
        #
        #   @param logos [Array<BrandDev::Models::BrandRetrieveByEmailResponse::Brand::Logo>] An array of logos associated with the brand. When a similarly shaped SVG variant
        #
        ...
        class Color < BrandDev::Internal::Type::BaseModel
          ...
          #   logo image pixels.
          #
          #   @return [Symbol, BrandDev::Models::BrandRetrieveByEmailResponse::Brand::Color::Source, nil]
          optional :source, enum: -> { BrandDev::Models::BrandRetrieveByEmailResponse::Brand::Color::Source }

          # @!method initialize(hex: nil, name: nil, source: nil)
          #   Some parameter documentations has been truncated, see
          #   {BrandDev::Models::BrandRetrieveByEmailResponse::Brand::Color} for more details.
          #
          #   @param hex [String] Color in hexadecimal format
          #
          #   @param name [String] Name of the color
          #
          #   @param source [Symbol, BrandDev::Models::BrandRetrieveByEmailResponse::Brand::Color::Source] Where the color was observed: 'site' colors come from the website's own theme si

          # Where the color was observed: 'site' colors come from the website's own theme
          # signals (rendered page colors, manifest, theme-color meta), 'logo' colors from
          # logo image pixels.
          #
          # @see BrandDev::Models::BrandRetrieveByEmailResponse::Brand::Color#source
          module Source
            extend BrandDev::Internal::Type::Enum
        ...
        # @see BrandDev::Models::BrandRetrieveByEmailResponse::Brand#employees
        class Employees < BrandDev::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, BrandDev::Models::BrandRetrieveByEmailResponse::Brand::Employees::Range, nil]
          optional :range, enum: -> { BrandDev::Models::BrandRetrieveByEmailResponse::Brand::Employees::Range }
          ...
          #
          #   @param range [Symbol, BrandDev::Models::BrandRetrieveByEmailResponse::Brand::Employees::Range] Employee count range for the brand (e.g. '11 to 50')

          # Employee count range for the brand (e.g. '11 to 50')
          #
          # @see BrandDev::Models::BrandRetrieveByEmailResponse::Brand::Employees#range
          module Range
            extend BrandDev::Internal::Type::Enum
      ...
      # @see BrandDev::Models::BrandRetrieveByEmailResponse#key_metadata
