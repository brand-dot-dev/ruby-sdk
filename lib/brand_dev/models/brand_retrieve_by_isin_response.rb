...
module BrandDev
  module Models
    ...
    class BrandRetrieveByIsinResponse < BrandDev::Internal::Type::BaseModel
      # @!attribute cache_metadata
      #   Cache outcome for this response. Composite responses are hits only when every
      #   cache-controlled fetch contributing to the output was a hit; age_ms is the
      #   oldest contributing hit.
      #
      #   @return [BrandDev::Models::BrandRetrieveByIsinResponse::CacheMetadata]
      required :cache_metadata, -> { BrandDev::Models::BrandRetrieveByIsinResponse::CacheMetadata }

      # @!attribute brand
      #   Detailed brand information
      #
      #   @return [BrandDev::Models::BrandRetrieveByIsinResponse::Brand, nil]
      optional :brand, -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand }
      ...
      #
      #   @return [BrandDev::Models::BrandRetrieveByIsinResponse::KeyMetadata, nil]
      optional :key_metadata, -> { BrandDev::Models::BrandRetrieveByIsinResponse::KeyMetadata }
      ...
      #   {BrandDev::Models::BrandRetrieveByIsinResponse} for more details.
      #
      #   @param cache_metadata [BrandDev::Models::BrandRetrieveByIsinResponse::CacheMetadata] Cache outcome for this response. Composite responses are hits only when every ca
      #
      #   @param brand [BrandDev::Models::BrandRetrieveByIsinResponse::Brand] Detailed brand information
      #
      #   @param code [Integer] HTTP status code
      #
      #   @param key_metadata [BrandDev::Models::BrandRetrieveByIsinResponse::KeyMetadata] Metadata about the API key used for the request. Included in every response when
      #
      #   @param status [String] Status of the response, e.g., 'ok'

      # @see BrandDev::Models::BrandRetrieveByIsinResponse#cache_metadata
      class CacheMetadata < BrandDev::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::CacheMetadata::Status]
        required :status, enum: -> { BrandDev::Models::BrandRetrieveByIsinResponse::CacheMetadata::Status }

        # @!method initialize(age_ms:, status:)
        #   Some parameter documentations has been truncated, see
        #   {BrandDev::Models::BrandRetrieveByIsinResponse::CacheMetadata} for more details.
        #
        #   Cache outcome for this response. Composite responses are hits only when every
        #   cache-controlled fetch contributing to the output was a hit; age_ms is the
        #   oldest contributing hit.
        ...
        #
        #   @param status [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::CacheMetadata::Status] Whether the response was served from cache, required fresh work, or honored zero

        # Whether the response was served from cache, required fresh work, or honored
        # zero-data-retention cache bypass.
        #
        # @see BrandDev::Models::BrandRetrieveByIsinResponse::CacheMetadata#status
        module Status
      ...
      # @see BrandDev::Models::BrandRetrieveByIsinResponse#brand
      class Brand < BrandDev::Internal::Type::BaseModel
        # @!attribute address
        #   Physical address of the brand
        #
        #   @return [BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Address, nil]
        optional :address, -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Address }

        # @!attribute backdrops
        #   An array of backdrop images for the brand
        #
        #   @return [Array<BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop>, nil]
        optional :backdrops,
                 -> { BrandDev::Internal::Type::ArrayOf[BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop] }

        # @!attribute colors
        #   An array of brand colors
        #
        #   @return [Array<BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Color>, nil]
        optional :colors,
                 -> { BrandDev::Internal::Type::ArrayOf[BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Color] }
        ...
        #
        #   @return [BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Employees, nil]
        optional :employees, -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Employees }

        # @!attribute industries
        #   Industry classification information for the brand
        #
        #   @return [BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Industries, nil]
        optional :industries, -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Industries }
        ...
        #
        #   @return [BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Links, nil]
        optional :links, -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Links }
        ...
        #   is preserved
        #
        #   @return [Array<BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo>, nil]
        optional :logos,
                 -> { BrandDev::Internal::Type::ArrayOf[BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo] }
        ...
        #
        #   @return [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::PrimaryLanguage, nil]
        optional :primary_language,
                 enum: -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand::PrimaryLanguage },
                 nil?: true
        ...
        #
        #   @return [Array<BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Social>, nil]
        optional :socials,
                 -> { BrandDev::Internal::Type::ArrayOf[BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Social] }

        # @!attribute stock
        #   Stock market information for this brand (will be null if not a publicly traded
        #   company)
        #
        #   @return [BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Stock, nil]
        optional :stock, -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Stock }
        ...
        #   Some parameter documentations has been truncated, see
        #   {BrandDev::Models::BrandRetrieveByIsinResponse::Brand} for more details.
        #
        #   Detailed brand information
        #
        #   @param address [BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Address] Physical address of the brand
        #
        #   @param backdrops [Array<BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop>] An array of backdrop images for the brand
        #
        #   @param colors [Array<BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Color>] An array of brand colors
        #
        ...
        #
        #   @param employees [BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Employees] Employee headcount information for the brand (will be null if unknown)
        #
        #   @param industries [BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Industries] Industry classification information for the brand
        #
        #   @param is_nsfw [Boolean] Indicates whether the brand content is not safe for work (NSFW)
        #
        #   @param links [BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Links] Important website links for the brand
        #
        #   @param logos [Array<BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo>] An array of logos associated with the brand. When a similarly shaped SVG variant
        #
        #   @param phone [String] Company phone number
        #
        #   @param primary_language [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::PrimaryLanguage, nil] Language to force for the retrieved brand data.
        #
        #   @param slogan [String] The brand's slogan
        #
        #   @param socials [Array<BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Social>] An array of social media links for the brand
        #
        #   @param stock [BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Stock] Stock market information for this brand (will be null if not a publicly traded c
        #
        #   @param title [String] The title or name of the brand

        # @see BrandDev::Models::BrandRetrieveByIsinResponse::Brand#address
        ...
        class Backdrop < BrandDev::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop::Color>, nil]
          optional :colors,
                   -> { BrandDev::Internal::Type::ArrayOf[BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop::Color] }

          # @!attribute resolution
          #   Resolution of the backdrop image
          #
          #   @return [BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop::Resolution, nil]
          optional :resolution, -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop::Resolution }
          ...
          #   @param colors [Array<BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop::Color>] Array of colors in the backdrop image
          #
          #   @param resolution [BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop::Resolution] Resolution of the backdrop image
          #
          ...
          # @see BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Backdrop#resolution
        ...
        class Color < BrandDev::Internal::Type::BaseModel
          ...
          #   logo image pixels.
          #
          #   @return [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Color::Source, nil]
          optional :source, enum: -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Color::Source }

          # @!method initialize(hex: nil, name: nil, source: nil)
          #   Some parameter documentations has been truncated, see
          #   {BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Color} for more details.
          #
          #   @param hex [String] Color in hexadecimal format
          #
          #   @param name [String] Name of the color
          #
          #   @param source [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Color::Source] Where the color was observed: 'site' colors come from the website's own theme si

          # Where the color was observed: 'site' colors come from the website's own theme
          # signals (rendered page colors, manifest, theme-color meta), 'logo' colors from
          # logo image pixels.
          #
          # @see BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Color#source
          module Source
            extend BrandDev::Internal::Type::Enum
        ...
        # @see BrandDev::Models::BrandRetrieveByIsinResponse::Brand#employees
        class Employees < BrandDev::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Employees::Range, nil]
          optional :range, enum: -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Employees::Range }
          ...
          #
          #   @param range [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Employees::Range] Employee count range for the brand (e.g. '11 to 50')

          # Employee count range for the brand (e.g. '11 to 50')
          #
          # @see BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Employees#range
          module Range
            extend BrandDev::Internal::Type::Enum
        ...
        # @see BrandDev::Models::BrandRetrieveByIsinResponse::Brand#industries
        class Industries < BrandDev::Internal::Type::BaseModel
          # @!attribute eic
          #   Easy Industry Classification - array of industry and subindustry pairs
          #
          #   @return [Array<BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic>, nil]
          optional :eic,
                   -> { BrandDev::Internal::Type::ArrayOf[BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic] }

          # @!method initialize(eic: nil)
          #   Industry classification information for the brand
          #
          #   @param eic [Array<BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic>] Easy Industry Classification - array of industry and subindustry pairs

          class Eic < BrandDev::Internal::Type::BaseModel
            # @!attribute industry
            #   Industry classification enum
            #
            #   @return [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic::Industry]
            required :industry,
                     enum: -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic::Industry }

            # @!attribute subindustry
            #   Subindustry classification enum
            #
            #   @return [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic::Subindustry]
            required :subindustry,
                     enum: -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic::Subindustry }

            # @!method initialize(industry:, subindustry:)
            #   @param industry [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic::Industry] Industry classification enum
            #
            #   @param subindustry [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic::Subindustry] Subindustry classification enum

            # Industry classification enum
            #
            # @see BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic#industry
            module Industry
              extend BrandDev::Internal::Type::Enum
            ...
            # Subindustry classification enum
            #
            # @see BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Industries::Eic#subindustry
            module Subindustry
              extend BrandDev::Internal::Type::Enum
        ...
        # @see BrandDev::Models::BrandRetrieveByIsinResponse::Brand#links
        ...
        class Logo < BrandDev::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Color>, nil]
          optional :colors,
                   -> { BrandDev::Internal::Type::ArrayOf[BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Color] }
          ...
          #
          #   @return [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Mode, nil]
          optional :mode, enum: -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Mode }

          # @!attribute resolution
          #   Resolution of the logo image
          #
          #   @return [BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Resolution, nil]
          optional :resolution, -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Resolution }

          # @!attribute type
          #   Type of the logo based on resolution (e.g., 'icon', 'logo')
          #
          #   @return [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Type, nil]
          optional :type, enum: -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Type }
          ...
          #   Some parameter documentations has been truncated, see
          #   {BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo} for more details.
          #
          #   @param colors [Array<BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Color>] Array of colors in the logo
          #
          #   @param mode [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Mode] Indicates when this logo is best used: 'light' = best for light mode, 'dark' = b
          #
          #   @param resolution [BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Resolution] Resolution of the logo image
          #
          #   @param type [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo::Type] Type of the logo based on resolution (e.g., 'icon', 'logo')
          #
          ...
          # has its own background
          #
          # @see BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo#mode
          module Mode
            extend BrandDev::Internal::Type::Enum
          ...
          # @see BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo#resolution
          class Resolution < BrandDev::Internal::Type::BaseModel
            # @!attribute aspect_ratio
            #   Aspect ratio of the image (width/height)
            #
          ...
          # Type of the logo based on resolution (e.g., 'icon', 'logo')
          #
          # @see BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Logo#type
          module Type
            extend BrandDev::Internal::Type::Enum
        ...
        # Language to force for the retrieved brand data.
        #
        # @see BrandDev::Models::BrandRetrieveByIsinResponse::Brand#primary_language
        ...
        class Social < BrandDev::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Social::Type, nil]
          optional :type, enum: -> { BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Social::Type }
          ...
          #   @param type [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Social::Type] Type of social media platform
          #
          #   @param url [String] URL of the social media page

          # Type of social media platform
          #
          # @see BrandDev::Models::BrandRetrieveByIsinResponse::Brand::Social#type
          module Type
            extend BrandDev::Internal::Type::Enum
        ...
        # @see BrandDev::Models::BrandRetrieveByIsinResponse::Brand#stock
      ...
      # @see BrandDev::Models::BrandRetrieveByIsinResponse#key_metadata
