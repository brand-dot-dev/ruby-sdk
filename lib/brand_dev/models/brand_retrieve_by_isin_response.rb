  ...
  module Models
    ...
    class BrandRetrieveByIsinResponse < BrandDev::Internal::Type::BaseModel
      ...
      class Brand < BrandDev::Internal::Type::BaseModel
        ...
        #
        #   @param primary_language [Symbol, BrandDev::Models::BrandRetrieveByIsinResponse::Brand::PrimaryLanguage, nil] The primary language of the brand's website content. Detected from the HTML lang
        #
