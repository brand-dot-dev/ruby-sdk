  ...
  module Models
    ...
    class BrandRetrieveByNameResponse < BrandDev::Internal::Type::BaseModel
      ...
      class Brand < BrandDev::Internal::Type::BaseModel
        ...
        #
        #   @param primary_language [Symbol, BrandDev::Models::BrandRetrieveByNameResponse::Brand::PrimaryLanguage, nil] The primary language of the brand's website content. Detected from the HTML lang
        #
