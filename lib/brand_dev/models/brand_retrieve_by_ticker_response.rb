  ...
  module Models
    ...
    class BrandRetrieveByTickerResponse < BrandDev::Internal::Type::BaseModel
      ...
      class Brand < BrandDev::Internal::Type::BaseModel
        ...
        #
        #   @return [BrandDev::Models::BrandRetrieveByTickerResponse::Brand::Industries, nil]
        optional :industries, -> { BrandDev::Models::BrandRetrieveByTickerResponse::Brand::Industries }
        ...
        #
        #   @return [BrandDev::Models::BrandRetrieveByTickerResponse::Brand::Links, nil]
        ...
        #
        #   @param primary_language [Symbol, BrandDev::Models::BrandRetrieveByTickerResponse::Brand::PrimaryLanguage, nil] The primary language of the brand's website content. Detected from the HTML lang
        #
        ...
        class Industries < BrandDev::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<BrandDev::Models::BrandRetrieveByTickerResponse::Brand::Industries::Eic>, nil]
          optional :eic,
                   -> { BrandDev::Internal::Type::ArrayOf[BrandDev::Models::BrandRetrieveByTickerResponse::Brand::Industries::Eic] }

          # @!method initialize(eic: nil)
          #   Industry classification information for the brand
          #
          #   @param eic [Array<BrandDev::Models::BrandRetrieveByTickerResponse::Brand::Industries::Eic>] Easy Industry Classification - array of industry and subindustry pairs

          class Eic < BrandDev::Internal::Type::BaseModel
            # @!attribute industry
            #   Industry classification enum
            #
            #   @return [Symbol, BrandDev::Models::BrandRetrieveByTickerResponse::Brand::Industries::Eic::Industry]
            required :industry,
                     enum: -> { BrandDev::Models::BrandRetrieveByTickerResponse::Brand::Industries::Eic::Industry }

            # @!attribute subindustry
            #   Subindustry classification enum
            #
            #   @return [Symbol, BrandDev::Models::BrandRetrieveByTickerResponse::Brand::Industries::Eic::Subindustry]
            required :subindustry,
                     enum: -> { BrandDev::Models::BrandRetrieveByTickerResponse::Brand::Industries::Eic::Subindustry }

            # @!method initialize(industry:, subindustry:)
            #   @param industry [Symbol, BrandDev::Models::BrandRetrieveByTickerResponse::Brand::Industries::Eic::Industry] Industry classification enum
            #
            #   @param subindustry [Symbol, BrandDev::Models::BrandRetrieveByTickerResponse::Brand::Industries::Eic::Subindustry] Subindustry classification enum

            # Industry classification enum
            #
            # @see BrandDev::Models::BrandRetrieveByTickerResponse::Brand::Industries::Eic#industry
            module Industry
            ...
            # Subindustry classification enum
            #
            # @see BrandDev::Models::BrandRetrieveByTickerResponse::Brand::Industries::Eic#subindustry
            module Subindustry
              extend BrandDev::Internal::Type::Enum
        ...
        # @see BrandDev::Models::BrandRetrieveByTickerResponse::Brand#links
