  ...
  module Models
    ...
    class BrandRetrieveResponse < BrandDev::Internal::Type::BaseModel
      ...
      class Brand < BrandDev::Internal::Type::BaseModel
        ...
        #
        #   @param primary_language [Symbol, BrandDev::Models::BrandRetrieveResponse::Brand::PrimaryLanguage, nil] The primary language of the brand's website content. Detected from the HTML lang
        #
