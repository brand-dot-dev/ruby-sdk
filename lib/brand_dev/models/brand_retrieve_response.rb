...
module BrandDev
  module Models
    ...
    class BrandRetrieveResponse < BrandDev::Internal::Type::BaseModel
      ...
      #
      #   @return [BrandDev::Models::BrandRetrieveResponse::CacheMetadata]
      required :cache_metadata, -> { BrandDev::Models::BrandRetrieveResponse::CacheMetadata }
      ...
      #
      #   @return [BrandDev::Models::BrandRetrieveResponse::KeyMetadata, nil]
      optional :key_metadata, -> { BrandDev::Models::BrandRetrieveResponse::KeyMetadata }
      ...
      #   {BrandDev::Models::BrandRetrieveResponse} for more details.
      #
      #   @param cache_metadata [BrandDev::Models::BrandRetrieveResponse::CacheMetadata] Cache outcome for this response. Composite responses are hits only when every ca
      #
      #   @param brand [BrandDev::Models::BrandRetrieveResponse::Brand] Detailed brand information
      #
      #   @param code [Integer] HTTP status code
      #
      #   @param key_metadata [BrandDev::Models::BrandRetrieveResponse::KeyMetadata] Metadata about the API key used for the request. Included in every response when
      #
      #   @param status [String] Status of the response, e.g., 'ok'

      # @see BrandDev::Models::BrandRetrieveResponse#cache_metadata
      class CacheMetadata < BrandDev::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, BrandDev::Models::BrandRetrieveResponse::CacheMetadata::Status]
        required :status, enum: -> { BrandDev::Models::BrandRetrieveResponse::CacheMetadata::Status }

        # @!method initialize(age_ms:, status:)
        #   Some parameter documentations has been truncated, see
        #   {BrandDev::Models::BrandRetrieveResponse::CacheMetadata} for more details.
        #
        #   Cache outcome for this response. Composite responses are hits only when every
        #   cache-controlled fetch contributing to the output was a hit; age_ms is the
        #   oldest contributing hit.
        ...
        #
        #   @param status [Symbol, BrandDev::Models::BrandRetrieveResponse::CacheMetadata::Status] Whether the response was served from cache, required fresh work, or honored zero

        # Whether the response was served from cache, required fresh work, or honored
        # zero-data-retention cache bypass.
        #
        # @see BrandDev::Models::BrandRetrieveResponse::CacheMetadata#status
        module Status
      ...
      class Brand < BrandDev::Internal::Type::BaseModel
        ...
        #
        #   @return [BrandDev::Models::BrandRetrieveResponse::Brand::Employees, nil]
        optional :employees, -> { BrandDev::Models::BrandRetrieveResponse::Brand::Employees }
        ...
        #
        #   @return [Symbol, BrandDev::Models::BrandRetrieveResponse::Brand::PrimaryLanguage, nil]
        optional :primary_language,
                 enum: -> { BrandDev::Models::BrandRetrieveResponse::Brand::PrimaryLanguage },
                 nil?: true
        ...
        #
        #   @param employees [BrandDev::Models::BrandRetrieveResponse::Brand::Employees] Employee headcount information for the brand (will be null if unknown)
        #
        ...
        #
        #   @param logos [Array<BrandDev::Models::BrandRetrieveResponse::Brand::Logo>] An array of logos associated with the brand. When a similarly shaped SVG variant
        #
        #   @param phone [String] Company phone number
        #
        #   @param primary_language [Symbol, BrandDev::Models::BrandRetrieveResponse::Brand::PrimaryLanguage, nil] Language to force for the retrieved brand data.
        #
        ...
        class Color < BrandDev::Internal::Type::BaseModel
          ...
          #   logo image pixels.
          #
          #   @return [Symbol, BrandDev::Models::BrandRetrieveResponse::Brand::Color::Source, nil]
          optional :source, enum: -> { BrandDev::Models::BrandRetrieveResponse::Brand::Color::Source }

          # @!method initialize(hex: nil, name: nil, source: nil)
          #   Some parameter documentations has been truncated, see
          #   {BrandDev::Models::BrandRetrieveResponse::Brand::Color} for more details.
          #
          #   @param hex [String] Color in hexadecimal format
          #
          #   @param name [String] Name of the color
          #
          #   @param source [Symbol, BrandDev::Models::BrandRetrieveResponse::Brand::Color::Source] Where the color was observed: 'site' colors come from the website's own theme si

          # Where the color was observed: 'site' colors come from the website's own theme
          # signals (rendered page colors, manifest, theme-color meta), 'logo' colors from
          # logo image pixels.
          #
          # @see BrandDev::Models::BrandRetrieveResponse::Brand::Color#source
          module Source
            extend BrandDev::Internal::Type::Enum
        ...
        # @see BrandDev::Models::BrandRetrieveResponse::Brand#employees
        class Employees < BrandDev::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, BrandDev::Models::BrandRetrieveResponse::Brand::Employees::Range, nil]
          optional :range, enum: -> { BrandDev::Models::BrandRetrieveResponse::Brand::Employees::Range }
          ...
          #
          #   @param range [Symbol, BrandDev::Models::BrandRetrieveResponse::Brand::Employees::Range] Employee count range for the brand (e.g. '11 to 50')

          # Employee count range for the brand (e.g. '11 to 50')
          #
          # @see BrandDev::Models::BrandRetrieveResponse::Brand::Employees#range
          module Range
            extend BrandDev::Internal::Type::Enum
        ...
        # Language to force for the retrieved brand data.
        #
        # @see BrandDev::Models::BrandRetrieveResponse::Brand#primary_language
        ...
        class Social < BrandDev::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, BrandDev::Models::BrandRetrieveResponse::Brand::Social::Type, nil]
          optional :type, enum: -> { BrandDev::Models::BrandRetrieveResponse::Brand::Social::Type }
          ...
          #   @param type [Symbol, BrandDev::Models::BrandRetrieveResponse::Brand::Social::Type] Type of social media platform
          #
          #   @param url [String] URL of the social media page

          # Type of social media platform
          #
          # @see BrandDev::Models::BrandRetrieveResponse::Brand::Social#type
          module Type
            extend BrandDev::Internal::Type::Enum
      ...
      # @see BrandDev::Models::BrandRetrieveResponse#key_metadata
