...
module BrandDev
  module Models
    class BrandAIProductResponse < BrandDev::Internal::Type::BaseModel
      ...
      sig { returns(BrandDev::Models::BrandAIProductResponse::CacheMetadata) }
      attr_reader :cache_metadata

      sig do
        params(
          cache_metadata:
            BrandDev::Models::BrandAIProductResponse::CacheMetadata::OrHash
        ).void
      end
      ...
      sig do
        override.returns(
          {
            cache_metadata:
              BrandDev::Models::BrandAIProductResponse::CacheMetadata,
            is_product_page: T::Boolean,
      ...
      class CacheMetadata < BrandDev::Internal::Type::BaseModel
        ...
        sig do
          returns(
            BrandDev::Models::BrandAIProductResponse::CacheMetadata::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            age_ms: Integer,
            status:
              BrandDev::Models::BrandAIProductResponse::CacheMetadata::Status::OrSymbol
          ).returns(T.attached_class)
        end
        def self.new(
          # Age of the cached data in milliseconds. Zero for miss and zdr responses.
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                BrandDev::Models::BrandAIProductResponse::CacheMetadata::Status
              )
            end
