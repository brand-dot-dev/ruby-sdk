...
module BrandDev
  module Models
    class BrandRetrieveResponse < BrandDev::Internal::Type::BaseModel
      ...
      sig { returns(BrandDev::Models::BrandRetrieveResponse::CacheMetadata) }
      attr_reader :cache_metadata

      sig do
        params(
          cache_metadata:
            BrandDev::Models::BrandRetrieveResponse::CacheMetadata::OrHash
        ).void
      end
      ...
      sig do
        returns(T.nilable(BrandDev::Models::BrandRetrieveResponse::KeyMetadata))
      end
      ...
      sig do
        params(
          key_metadata:
            BrandDev::Models::BrandRetrieveResponse::KeyMetadata::OrHash
        ).void
      end
      ...
      sig do
        override.returns(
          {
            cache_metadata:
              BrandDev::Models::BrandRetrieveResponse::CacheMetadata,
            brand: BrandDev::Models::BrandRetrieveResponse::Brand,
            code: Integer,
            key_metadata: BrandDev::Models::BrandRetrieveResponse::KeyMetadata,
            status: String
          }
        )
      end
      ...
      class CacheMetadata < BrandDev::Internal::Type::BaseModel
        ...
        sig do
          returns(
            BrandDev::Models::BrandRetrieveResponse::CacheMetadata::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            age_ms: Integer,
            status:
              BrandDev::Models::BrandRetrieveResponse::CacheMetadata::Status::OrSymbol
          ).returns(T.attached_class)
        end
        def self.new(
          # Age of the cached data in milliseconds. Zero for miss and zdr responses.
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                BrandDev::Models::BrandRetrieveResponse::CacheMetadata::Status
              )
            end
      ...
      class Brand < BrandDev::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(BrandDev::Models::BrandRetrieveResponse::Brand::Employees)
          )
        end
        ...
        sig do
          params(
            employees:
              BrandDev::Models::BrandRetrieveResponse::Brand::Employees::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              BrandDev::Models::BrandRetrieveResponse::Brand::PrimaryLanguage::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            ...
            primary_language:
              T.nilable(
                BrandDev::Models::BrandRetrieveResponse::Brand::PrimaryLanguage::OrSymbol
              ),
            slogan: String,
            socials:
              T::Array[
          ...
          override.returns(
            {
              ...
              email: String,
              employees:
                BrandDev::Models::BrandRetrieveResponse::Brand::Employees,
              industries:
                BrandDev::Models::BrandRetrieveResponse::Brand::Industries,
              is_nsfw: T::Boolean,
        ...
        class Color < BrandDev::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                BrandDev::Models::BrandRetrieveResponse::Brand::Color::Source::TaggedSymbol
              )
            )
          end
          attr_reader :source
          ...
          sig do
            params(
              source:
                BrandDev::Models::BrandRetrieveResponse::Brand::Color::Source::OrSymbol
            ).void
          end
          attr_writer :source
          ...
          module Source
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  BrandDev::Models::BrandRetrieveResponse::Brand::Color::Source
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Employees < BrandDev::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                BrandDev::Models::BrandRetrieveResponse::Brand::Employees::Range::TaggedSymbol
              )
            )
          end
          attr_reader :range
          ...
          sig do
            params(
              range:
                BrandDev::Models::BrandRetrieveResponse::Brand::Employees::Range::OrSymbol
            ).void
          end
          attr_writer :range
          ...
          module Range
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  BrandDev::Models::BrandRetrieveResponse::Brand::Employees::Range
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module PrimaryLanguage
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                BrandDev::Models::BrandRetrieveResponse::Brand::PrimaryLanguage
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class KeyMetadata < BrandDev::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              BrandDev::Models::BrandRetrieveResponse::KeyMetadata,
              BrandDev::Internal::AnyHash
            )
          end
