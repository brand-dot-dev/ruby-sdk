          ...
          T.nilable(
            T::Array[
              T.any(
                ...
                BrandDev::BrandWebScrapeMdParams::Action::Scroll
              )
            ]
          )
        )
      ...
      module Action
        ...
        class Scroll < BrandDev::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T.any(
                  Integer,
                  BrandDev::BrandWebScrapeMdParams::Action::Scroll::Amount::OrSymbol
                )
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                BrandDev::BrandWebScrapeMdParams::Action::Scroll::Direction::OrSymbol
              )
            )
          end
          ...
          module Amount
            ...
            Variants =
              T.type_alias do
                T.any(
                  Integer,
                  BrandDev::BrandWebScrapeMdParams::Action::Scroll::Amount::TaggedSymbol
                )
              end
            ...
            sig do
              override.returns(
                T::Array[
                  BrandDev::BrandWebScrapeMdParams::Action::Scroll::Amount::Variants
                ]
              )
            end
            def self.variants
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  BrandDev::BrandWebScrapeMdParams::Action::Scroll::Amount
                )
              end
          ...
          module Direction
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  BrandDev::BrandWebScrapeMdParams::Action::Scroll::Direction
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            UP =
              T.let(
                :up,
                BrandDev::BrandWebScrapeMdParams::Action::Scroll::Direction::TaggedSymbol
              )
            DOWN =
              T.let(
                :down,
