...
class BrandDev::Test::PrimitiveModelTest < Minitest::Test
  A = BrandDev::Internal::Type::ArrayOf[-> { Integer }]
  H = BrandDev::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < BrandDev::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => BrandDev::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [BrandDev::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [BrandDev::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [BrandDev::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        BrandDev::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [BrandDev::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [BrandDev::Internal::Type::Boolean, true] => true,
      [BrandDev::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => BrandDev::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        BrandDev::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = BrandDev::Internal::Type::Converter.new_coerce_state
      BrandDev::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        BrandDev::Internal::Type::Converter.dump(target, input, state: state)
...
class BrandDev::Test::EnumModelTest < Minitest::Test
  class E0
    include BrandDev::Internal::Type::Enum
    attr_reader :values
...
class BrandDev::Test::CollectionModelTest < Minitest::Test
  A1 = BrandDev::Internal::Type::ArrayOf[-> { Integer }]
  H1 = BrandDev::Internal::Type::HashOf[Integer]

  A2 = BrandDev::Internal::Type::ArrayOf[H1]
  H2 = BrandDev::Internal::Type::HashOf[-> { A1 }]

  A3 = BrandDev::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = BrandDev::Internal::Type::HashOf[Integer, nil?: true]
...
class BrandDev::Test::BaseModelTest < Minitest::Test
  class M1 < BrandDev::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < BrandDev::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < BrandDev::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, BrandDev::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = BrandDev::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = BrandDev::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(BrandDev::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue BrandDev::Errors::ConversionError => e
...
class BrandDev::Test::UnionTest < Minitest::Test
  class U0
    include BrandDev::Internal::Type::Union
  ...
  class M2 < BrandDev::Internal::Type::BaseModel
  ...
  class M4 < BrandDev::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, BrandDev::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < BrandDev::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, BrandDev::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class BrandDev::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include BrandDev::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [BrandDev::Internal::Type::Unknown, BrandDev::Internal::Type::Unknown] => true,
      [BrandDev::Internal::Type::Boolean, BrandDev::Internal::Type::Boolean] => true,
      [BrandDev::Internal::Type::Unknown, BrandDev::Internal::Type::Boolean] => false,
...
class BrandDev::Test::MetaInfoTest < Minitest::Test
  A1 = BrandDev::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = BrandDev::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
